...
//            CURLOPT_VERBOSE => true,
    ...
    public function traeStock()
    {
        ...
        $monitor = new MonitorFlujoController(0, "Robot Stock APC");
...
//                            Log::channel('robots')->info("Procesando " . $row['numero_vin']);
    ...
    public function traeStockUsados()
    {
        set_time_limit(0);
        ini_set('memory_limit', '1024M');
        $monitor = new MonitorFlujoController(0, "Robot Stock Usados APC");
...
//        unlink(storage_path('/app/public/' . $filename));
    ...
    public function traeStockAnual()
    {
        ...
        $monitor = new MonitorFlujoController(0, "Robot Stock Anual APC");
...
//            'Margen_porcentaje' => ($row['margen'] != '') ? $row['margen'] : null,
    ...
    public function traeStockAll()
    {
        ...
        ini_set('display_startup_errors', 1);
        error_reporting(E_ALL);
        $monitor = new MonitorFlujoController(0, "Robot Stock COMPLETO APC");
...
//            'Margen_porcentaje' => ($row['margen'] != '') ? $row['margen'] : null,
    ...
    public function traeSku()
    {
        ...
        set_time_limit(0);
        $this->setCookie();
        $monitor = new MonitorFlujoController(0, "Robot Reporte SKU APC");
    ...
    public function traeRepuestos()
    {
        ...
        set_time_limit(0);
        $this->setCookie();
        $monitor = new MonitorFlujoController(0, "Robot Repuestos APC");
    ...
    public function traeMovimientosVentas()
    {
        set_time_limit(0);
        $this->setCookie();
        $monitor = new MonitorFlujoController(0, "Robot Movimiento Ventas APC");
    ...
    public function traeRentabilidadOt()
    {
        set_time_limit(0);
        $this->setCookie();
        $monitor = new MonitorFlujoController(0, "Robot Rentabilidad OT APC");
...
//            unlink(storage_path('/app/public/' . $filename));
    ...
    public function traeRentabilidadSku()
    {
        set_time_limit(0);
        $this->setCookie();
        $monitor = new MonitorFlujoController(0, "Robot Rentabilidad SKU APC");
    ...
    public function traeInformeOt()
    {
        set_time_limit(0);
        $this->setCookie();
        $monitor = new MonitorFlujoController(0, "Robot Informe OT APC");
...
//        }
    ...
    public function traeInformeOtAcotado()
    {
        set_time_limit(0);
        $this->setCookie();
        $monitor = new MonitorFlujoController(0, "Robot Informe OT 2 dias APC");
...
//        $options['form_params']['ctl00$PageContent$FechaToFilter'] = Carbon::now()->lastOfMonth()->format('d-m-Y');
    ...
    public function traeRentabilidadVenta()
    {
        set_time_limit(0);
        $this->setCookie();
        $monitor = new MonitorFlujoController(0, "Robot Ventas APC");
