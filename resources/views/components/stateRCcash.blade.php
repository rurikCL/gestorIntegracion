...
@elseif( $getState() === 3 )
    <span class="inline-flex items-center rounded-md  px-2 py-1 text-xs font-medium ring-1 ring-inset ring-green-600/20 "><i class="text-2xs heroicon-o-rectangle-stack text-red-800 pr-2"> </i> Rechazado</span>
@endif
